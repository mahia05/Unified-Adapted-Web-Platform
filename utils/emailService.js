            ...
            <div style="font-family:Segoe UI,Arial,sans-serif;max-width:560px;margin:40px auto;background:#fff;border-radius:18px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.10);">
              ...
              <div style="padding:28px 36px;">
                ...
                <div style="background:#F9F9F9;border-radius:12px;padding:4px 20px;margin-bottom:20px;">
                  <p style="padding:10px 0;border-bottom:1px solid #eee;margin:0;font-size:13.5px;"><strong style="color:#999;font-size:11px;text-transform:uppercase;">Name</strong><br>${name}</p>
                  <p style="padding:10px 0;border-bottom:1px solid #eee;margin:0;font-size:13.5px;"><strong style="color:#999;font-size:11px;text-transform:uppercase;">Email</strong><br>${email}</p>
                  <p style="padding:10px 0;border-bottom:1px solid #eee;margin:0;font-size:13.5px;"><strong style="color:#999;font-size:11px;text-transform:uppercase;">Phone</strong><br>${phone || '—'}</p>
                  <p style="padding:10px 0;border-bottom:1px solid #eee;margin:0;font-size:13.5px;"><strong style="color:#999;font-size:11px;text-transform:uppercase;">Help Type</strong><br>${helpType}</p>
                  <p style="padding:10px 0;margin:0;font-size:13.5px;"><strong style="color:#999;font-size:11px;text-transform:uppercase;">Urgency</strong><br>${urgency}</p>
                </div>
            ...
            <div style="font-family:Segoe UI,Arial,sans-serif;max-width:560px;margin:40px auto;background:#fff;border-radius:18px;overflow:hidden;box-shadow:0 8px 32px rgba(63,59,35,0.12);">
              ...
              <div style="padding:36px;">
                ...
                <div style="background:#EDFAF4;border-radius:12px;padding:20px 24px;border-left:4px solid #34C97B;margin-bottom:24px;">
                  <p style="margin:6px 0;font-size:13.5px;"><strong>Help Type:</strong> ${helpType}</p>
                  <p style="margin:6px 0;font-size:13.5px;"><strong>Your Request:</strong> ${description}</p>
                  <p style="margin:6px 0;font-size:13.5px;color:#157A4A;font-weight:700;">✅ Resolved</p>
                </div>
                ${adminNote ? `
                ...
                <p style="font-size:14px;color:#6b6445;">Thank you for using UAWP! 💛</p>
              </div>
